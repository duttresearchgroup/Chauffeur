...
EXTENDED_KALMAN_FILTER_MEMORY_OUTPUT_LOGS_ON_HOST=$LOGS_FOLDER_ON_HOST/kf_memory.txt
...
OPEN_MVG1_OUTPUT_LOGS=$LOGS_FOLDER/open_mvg_openMVG_main_ComputeFeatures_memory.txt
OPEN_MVG2_OUTPUT_LOGS=$LOGS_FOLDER/open_mvg_openMVG_main_ComputeMatches_memory.txt
OPEN_MVG3_OUTPUT_LOGS=$LOGS_FOLDER/open_mvg_openMVG_main_IncrementalSfM_memory.txt
OPEN_MVG4_OUTPUT_LOGS=$LOGS_FOLDER/open_mvg_openMVG_main_ComputeSfM_DataColor_memory.txt
OPEN_MVG5_OUTPUT_LOGS=$LOGS_FOLDER/open_mvg_openMVG_main_ComputeStructureFromKnownPoses_memory.txt
OPEN_MVG6_OUTPUT_LOGS=$LOGS_FOLDER/open_mvg_openMVG_main_ComputeSfM_DataColor_memory.txt

OPEN_MVG1_OUTPUT_LOGS_ON_HOST=$LOGS_FOLDER_ON_HOST/open_mvg_openMVG_main_ComputeFeatures_memory.txt
OPEN_MVG2_OUTPUT_LOGS_ON_HOST=$LOGS_FOLDER_ON_HOST/open_mvg_openMVG_main_ComputeMatches_memory.txt
OPEN_MVG3_OUTPUT_LOGS_ON_HOST=$LOGS_FOLDER_ON_HOST/open_mvg_openMVG_main_IncrementalSfM_memory.txt
OPEN_MVG4_OUTPUT_LOGS_ON_HOST=$LOGS_FOLDER_ON_HOST/open_mvg_openMVG_main_ComputeSfM_DataColor_memory.txt
OPEN_MVG5_OUTPUT_LOGS_ON_HOST=$LOGS_FOLDER_ON_HOST/open_mvg_openMVG_main_ComputeStructureFromKnownPoses_memory.txt
OPEN_MVG6_OUTPUT_LOGS_ON_HOST=$LOGS_FOLDER_ON_HOST/open_mvg_openMVG_main_ComputeSfM_DataColor_memory.txt
...
FLOAM_MEMORY_OUTPUT_LOGS_1_ON_HOST=$LOGS_FOLDER_ON_HOST/floam_odom_estimation_node_memory.txt
FLOAM_MEMORY_OUTPUT_LOGS_2_ON_HOST=$LOGS_FOLDER_ON_HOST/floam_laser_processing_node_memory.txt
...
HYBRID_ASTAR_MEMORY_OUTPUT_LOGS_1_ON_HOST=$LOGS_FOLDER_ON_HOST/h_a_star_map_server_memory.txt
HYBRID_ASTAR_MEMORY_OUTPUT_LOGS_2_ON_HOST=$LOGS_FOLDER_ON_HOST/h_a_star_tf_broadcaster_memory.txt
...
DARKNET_ROS_MEMORY_OUTPUT_LOGS_ON_HOST=$LOGS_FOLDER_ON_HOST/darknet_ros_memory.txt
...
ORBSLAM_MEMORY_OUTPUT_LOGS_ON_HOST=$LOGS_FOLDER_ON_HOST/orb_slam_3_memory.txt
...
LIDAR_TRACKING_MEMORY_OUTPUT_LOGS_ON_HOST=$LOGS_FOLDER_ON_HOST/lidar_tracking_memory.txt
