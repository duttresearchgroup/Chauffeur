### Script for FIG.9  Main-memory access pattern of selected Chauffeur applications from CPU cores. Applications demonstrate memory accesse phases (CUDA-LANE-DETECTION, DARKNET-ROS, LANENET-LANE-DETECTION)
